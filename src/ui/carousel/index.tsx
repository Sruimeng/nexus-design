...
interface TCarousel
  extends React.ForwardRefExoticComponent<
    React.HTMLAttributes<HTMLDivElement> & CarouselProps & React.RefAttributes<CarouselContext>
  > {
...
interface CarouselActionProps
  extends Omit<React.HTMLAttributes<HTMLButtonElement>, 'disabled' | 'onClick'> {
