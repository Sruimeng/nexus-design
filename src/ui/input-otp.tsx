...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'relative mr-4 flex size-10 items-center justify-center rounded-3 paper-input text-3 text-text-primary transition-all duration-fast ease-smooth last:mr-0',
